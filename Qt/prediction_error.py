...
try:
    ...
    #_dir =  sys.argv[1]
    _dir = "C:/final_project/Qt/testing/allowed/"
    ...
    model.load_weights('./models/save_model19.h5')
    logging.info('Model_Weights: {}'.format('Train Model loaded successfully!!'))
...
#logging.debug('Result_Convo: {} + {}'.format('Second Layer Executed'+ (names[p_classes[0][0]])))
